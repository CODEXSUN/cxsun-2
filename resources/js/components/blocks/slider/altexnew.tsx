...
const slides: Slide[] = [
    {
        ...
        image: 'https://images.unsplash.com/photo-1581093450021-4a7360e9a6b5?w=1920&h=1080&fit=crop&auto=format'
        // Modern lab with blue lighting — perfect first impression
    },
    {
        id: 2,
        ...
        image: 'https://images.unsplash.com/photo-1581092580496-3ed3e6a8d8e7?w=1920&h=1080&fit=crop&auto=format'
        // Scientist using spectrophotometer — shows technical expertise
    },
    {
        id: 3,
        ...
        // Professional team meeting — shows credibility & experience
    },
    {
        id: 4,
        ...
        image: 'https://images.unsplash.com/photo-1582719366760-1e486e92b3a8?w=1920&h=1080&fit=crop&auto=format'
        // Close-up of fabric testing machine — shows real capability
    },
    {
        id: 5,
        ...
        image: 'https://images.unsplash.com/photo-1581091462275-2d81c23f8e2e?w=1920&h=1080&fit=crop&auto=format'
        // Lab technician working fast — conveys speed & urgency
    },
    {
        id: 6,
        ...
        image: 'https://images.unsplash.com/photo-1581093577422-7e8d5c3e3b2f?w=1920&h=1080&fit=crop&auto=format'
        // Courier delivering package to lab — shows convenience
    }
];
...
export default function AlTexHeroSlider() {
    ...
    // Fixed: Extract icon component safely
    ...
    return (
        <div className="relative h-screen overflow-hidden bg-slate-950">
            ...
            <button
                onClick={prev}
                className="absolute left-6 top-1/2 -translate-y-1/2 z-30 rounded-full bg-white/20 p-4 backdrop-blur-xl text-white hover:bg-white/30 hover:scale-110 transition"
            >
                <ChevronLeft className="h-8 w-8" />
            </button>
            <button
                onClick={next}
                className="absolute right-6 top-1/2 -translate-y-1/2 z-30 rounded-full bg-white/20 p-4 backdrop-blur-xl text-white hover:bg-white/30 hover:scale-110 transition"
            >
